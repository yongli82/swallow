...
define(function(require, exports, module) {
    ...
    $(document).ready(function() {
        ...
        $("#btn-add-bean").click(function(){
            ...
            $("#submit-bean-form").attr("form_url", "/settle/ajax/createCompanyBusiness");
        });
    ...
    function show_list() {
        list.init("list_model", "record_list", "pagination_bar", "", "", "NoRowsTemplate", "search-container", null, 1, function (data) {
            ...
            $(".edit-action").click(function(){
                    ...
                    ajax.post("/settle/ajax/loadCompanyBusiness", {"recordId": record_id}, function(data) {
                        console.log(data);
                        var bean = data.bean;
                        form.clean("submit-bean-form");
                        ...
                        $("#submit-bean-form").attr("form_url", "/settle/ajax/updateCompanyBusiness");
                        $('#submit-bean-button').removeAttr("disabled");
            ...
            $('.delete-action').click('click', function () {
                ...
                dialog.init("删除设置", dialogContent, "确认", function () {
                    $.ajax({
                        type: "post",
                        dataType: "json",
                        url: "/settle/ajax/deleteCompanyBusiness",
                        data: {
                            "bean.id": record_id
                        },
